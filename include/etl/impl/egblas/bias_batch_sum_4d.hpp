...
#ifdef EGBLAS_HAS_SBIAS_BATCH_SUM_4D
    inc_counter("egblas");
    egblas_sbias_batch_sum_4d(b, m, n, s0, s1, A, lda, B, ldb);
#else
...
#ifdef EGBLAS_HAS_DBIAS_BATCH_SUM_4D
    inc_counter("egblas");
    egblas_dbias_batch_sum_4d(b, m, n, s0, s1, A, lda, B, ldb);
#else
    cpp_unreachable("Invalid call to egblas::bias_batch_sum_4d");
#endif
}
...
#ifdef EGBLAS_HAS_SBIAS_BATCH_MEAN_4D
    inc_counter("egblas");
    egblas_sbias_batch_mean_4d(b, m, n, s0, s1, A, lda, B, ldb);
#else
...
#ifdef EGBLAS_HAS_DBIAS_BATCH_MEAN_4D
    inc_counter("egblas");
    egblas_dbias_batch_mean_4d(b, m, n, s0, s1, A, lda, B, ldb);
#else
    cpp_unreachable("Invalid call to egblas::bias_batch_mean_4d");
#endif
}
